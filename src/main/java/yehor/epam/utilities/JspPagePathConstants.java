...
public final class JspPagePathConstants {
    ...
    public static final String ERROR_500_PAGE_PATH = "/WEB-INF/jsp/errors/error500.jsp";
    public static final String ERROR_PERMISSION_PAGE_PATH = "/WEB-INF/jsp/errors/errorPermits.jsp";
